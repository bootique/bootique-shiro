...
@JsonTypeName("tn-cs")
public class TreeNameCommaSeparatedClaimFactory extends JwtTokenClaimFactory {

    @Override
    public JwtClaim<?,?> provideClaim() {
        return new TreeNameCommaSeparatedClaim(getName());
    }

    static class TreeNameCommaSeparatedClaim extends CommaSeparatedClaimFactory.CommaSeparatedClaim {
        public TreeNameCommaSeparatedClaim(String name) {
            super(name);
        }
